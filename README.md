# v2dns (v2rayNG с интеграцией NullDnsTunneling)

**v2dns** — это специализированный форк популярного Android-клиента v2rayNG с глубокой интеграцией сверхзащищенного и быстрого протокола DNS-туннелирования **NullDnsTunneling** и удобным импортом конфигураций через компактные ссылки `mdns://`.
...
* **Полная интеграция NullDnsTunneling**: Поддержка современного, высокоскоростного DNS-туннелирования.
